...
This project implements a reinforcement learning controller for a simulated two-link robotic arm. The objective of the agent is to drive the arm's end-effector to a predefined target position in a 2D plane.
